...
public class PermutationsOfDigitsInNumber
{
        private int[] key;
        private String word, pWord;
        private int n, i = 1;
 
        public PermutationsOfDigitsInNumber(String word)
        {
                this.word = word;
        ...
        public PermutationsOfDigitsInNumber(int length) {
        ...
        {
        	//PermutationsOfDigitsInNumber p = new PermutationsOfDigitsInNumber(String.valueOf(101));
        	
        	int length = (int)(Math.log10(1204)+1);
        	PermutationsOfDigitsInNumber p = new PermutationsOfDigitsInNumber(length);
